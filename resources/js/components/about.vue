<template>
  <div>
		<div class="home about _mt_110">
			<div class="container">
                <p class="_title _text_center">About Us</p>
				<div class="home_all">
                        <!-- ITMES -->
                    <div class="row">
                        <div class="col-md-6 home_pic">
                            <div class="">
                                <img class="home_img" src="/img/valetimg.jpg" alt="">
                            </div>	
                        </div>	
